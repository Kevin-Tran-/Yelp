...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(term: String, offset2: Int, completion: ([Business]!, NSError!) -> Void) -> AFHTTPRequestOperation {
        return searchWithTerm(term, offset: offset2, sort: nil, categories: nil, deals: nil, completion: completion)
    }
